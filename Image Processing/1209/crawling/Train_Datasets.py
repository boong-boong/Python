...
dataset = CustomImageDataset(
    annotations_file='annotation_train.csv',
    img_dir='./train'
)
dataset_test = CustomImageDataset(
    annotations_file='annotation_test.csv',
    img_dir='./test'
)

train_loader = torch.utils.data.DataLoader(dataset, batch_size=64, shuffle=True)
test_loader = torch.utils.data.DataLoader(dataset_test, batch_size=5, shuffle=True, **kwargs)
