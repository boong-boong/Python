...
# dataset
train_dataset = catvsdogDataset("../../../../../Downloads/학습/dataset/train/", transform=train_transform)
val_dataset = catvsdogDataset("../../../../../Downloads/학습/dataset/val/", transform=val_transform)
